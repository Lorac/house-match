...
public class PropertyControllerTest extends MvcControllerTest {
    ...
    public void init() throws Exception {
        ...
        propertyController = new PropertyController(authorizationValidatorMock, propertyServiceMock, userServiceMock,
    ...
    @Test
    public void propertyControllerCallsAuthorizationValidationServiceOnPropertyCreationViewAccess() throws Exception {
        performGetRequest(PropertyController.PROPERTY_CREATION_URL);
        verify(authorizationValidatorMock).validateResourceAccess(PropertyController.PROPERTY_CREATION_VIEW_NAME,
                mockHttpSession, PropertyController.USER_ATTRIBUTE_NAME);
    }
    ...
    @Test
    public void propertyControllerCallsAuthorizationValidationServiceDuringPropertyCreation() throws Exception {
        postPropertyCreationForm();
        verify(authorizationValidatorMock).validateResourceAccess(PropertyController.PROPERTY_CREATION_VIEW_NAME,
                mockHttpSession, HomeController.USER_ATTRIBUTE_NAME);
    }
    ...
    @Test
    public void propertyControllerCallsAuthorizationValidationServiceOnDetailsViewAccess() throws Exception {
        performGetRequest(samplePropertyDetailsUpdateUrl);
        verify(authorizationValidatorMock).validateResourceAccess(PropertyController.PROPERTY_DETAILS_UPDATE_VIEW_NAME,
                mockHttpSession, PropertyController.USER_ATTRIBUTE_NAME);
    }
    ...
    @Test
    public void propertyControllerCallsAuthorizationValidationServiceOnDetailsUpdate() throws Exception {
