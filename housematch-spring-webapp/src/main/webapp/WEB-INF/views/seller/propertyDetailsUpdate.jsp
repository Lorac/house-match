            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                            ...
                            <form:select path="details.propertyStyle" class="form-control" tabindex="1">
                                <c:forEach var="propertyStyle" items="${propertyStyles}">
                                    <option value="${propertyStyle}"
                                        ${propertyStyle == propertyListingUpdateForm.details.propertyStyle ? 'selected' : ''}>${propertyStyle.displayName}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </div>
                            ...
                            <form:select path="details.ownershipType" class="form-control" tabindex="17">
                                <c:forEach var="ownershipType" items="${propertyOwnershipTypes}">
                                    <option value="${ownershipType}"
                                        ${ownershipType == propertyListingUpdateForm.details.ownershipType ? 'selected' : ''}>${ownershipType.displayName}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <form:input type="text" path="details.priceDetail" class="form-control" min="0" tabindex="2"
                            ...
                            <form:select path="details.backyardDirection" class="form-control" tabindex="17">
                                <c:forEach var="cardinalDirection" items="${cardinalDirections}">
                                    <option value="${cardinalDirection}"
                                        ${cardinalDirection == propertyListingUpdateForm.details.backyardDirection ? 'selected' : ''}>${cardinalDirection.displayName}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <form:input type="number" path="details.buildingDimensionsInSquareFeet" class="form-control" min="1"
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <form:input type="number" path="details.numberOfExteriorParkingSpaces" class="form-control" min="0"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <form:input type="number" path="details.numberOfInteriorParkingSpaces" class="form-control" min="0"
