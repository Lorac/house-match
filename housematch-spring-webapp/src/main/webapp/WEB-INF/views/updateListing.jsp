...
<body>
	...
	<div class="container">
		<h1 class="center">Edit a property</h1>
		<br>
		<form:form id="property-listing-creation-form" class="form-horizontal" role="form"
			commandName="propertyListingCreationForm" action="/updateListing" method="POST">
				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3">
						<input type="submit" name="property-listing-update-submit"
							id="property-listing-update-submit" tabindex="8" class="form-control btn"
