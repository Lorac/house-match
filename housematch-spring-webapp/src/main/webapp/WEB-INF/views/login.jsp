							...
							<div class="col-lg-12">
								<form:form id="login-form" role="form" commandName="loginForm"
									...
									<div class="form-group">
										...
										<form:input path="username" class="form-control" minlength="3"
											maxlength="32" tabindex="1" placeholder="Username" />
									</div>
									<div class="form-group">
										<label>Password:</label>
										<form:input type="password" path="password" minlength="3"
										...
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="login-submit"
													tabindex="3" class="form-control btn" value="Log In">
											</div>
										</div>
									</div>
								</form:form>
