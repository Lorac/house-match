            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form:form id="property-creation-form" role="form" commandName="propertyCreationForm" action="/sell"
                                    method="POST">
                                    ...
                                    <div class="form-group">
                                        <form:input type="text" path="address.additionalAddressInfo" class="form-control" minlength="3"
                                            maxlength="32" tabindex="5" placeholder="Floor / Building / Unit (optional)" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <form:input type="text" path="address.postCode" class="form-control" minlength="3" maxlength="7"
                                            tabindex="6" placeholder="Zip / Postal Code" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type="submit" name="property-creation-submit" id="property-creation-submit"
                                                    tabindex="8" class="form-control btn" value="Sell property">
                                            </div>
                                        </div>
                                    </div>
                                </form:form>
